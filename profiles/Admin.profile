...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <classAccesses>
        <apexClass>GilmoreLabs_FlowDataGridController</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>GilmoreLabs_FlowMapDataGridController</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>GilmoreLabs_FlowTileGridController</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>GilmoreLabs_TestClasses</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <custom>false</custom>
